...
uint32_t lastPress1 = 0;
uint32_t lastPress2 = 0;
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin) {
	...
	if(GPIO_Pin == BTN1_Pin) {
		...
		TimerPeriod = (1/t)*F_CLK/(htim3.Init.Prescaler);
